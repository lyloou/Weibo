...
public class StatusesAPI extends AbsOpenAPI {
    ...
    private static final int READ_API_USER_TIMELINE = 6;
    ...
    static {
        ...
        sAPIList.put(READ_API_USER_TIMELINE, API_BASE_URL + "/user_timeline.json");
    }
    ...
    public void userTimeline(long uid, String screen_name, long since_id, long max_id, int count, int page, boolean base_app,
                             int featureType, boolean trim_user, RequestListener listener) {
        WeiboParameters params =
                buildUserTimeLineParamsBase(uid, screen_name, since_id, max_id, count, page, base_app, trim_user, featureType);
        requestAsync(sAPIList.get(READ_API_USER_TIMELINE), params, HTTPMETHOD_GET, listener);
    }
    ...
    // 组装userTimeLines的参数
    private WeiboParameters buildUserTimeLineParamsBase(long uid, String screen_name, long since_id, long max_id, int count, int page,
                                                        boolean base_app, boolean trim_user, int featureType) {
        WeiboParameters params = new WeiboParameters(mAppKey);
        params.put("uid", uid);
